...
import { deleteBusinesses } from "@/lib/actions/bussiness.action";
import { useToast } from "./ui/use-toast";

const VerifiedBusiness = ({ verifiedBusinesses }: any) => {
  ...
  return (
    <>
      {verifiedBusinesses.length === 0 && (
        <p className="text-center">No business is verified</p>
      )}
      <div>
